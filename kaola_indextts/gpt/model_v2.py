...
from kaola_indextts.gpt.transformers_gpt2 import GPT2PreTrainedModel, GPT2Model
...
from kaola_indextts.utils.arch_util import AttentionBlock
from kaola_indextts.utils.typical_sampling import TypicalLogitsWarper
...
class UnifiedVoice(nn.Module):
    ...
    def post_init_gpt2_config(self, use_deepspeed=False, kv_cache=False, half=False):
        ...
        if self.use_accel and torch.cuda.is_available():
            ...
            from kaola_indextts.accel import GPT2AccelModel, AccelInferenceEngine
