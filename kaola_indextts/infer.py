...
from kaola_indextts.BigVGAN.models import BigVGAN as Generator
from kaola_indextts.gpt.model import UnifiedVoice
from kaola_indextts.utils.checkpoint import load_checkpoint
from kaola_indextts.utils.feature_extractors import MelSpectrogramFeatures
...
class IndexTTS:
    def __init__(
        ...
        #
        # from kaola_indextts.vqvae.xtts_dvae import DiscreteVAE
        ...
        if self.use_cuda_kernel:
            ...
            try:
                from kaola_indextts.BigVGAN.alias_free_activation.cuda import load
